...
#
#     from geopdf import metadata
#
# However, when we do this, we also import `geopdf/__init__.py'. If this
...
def _test():
    ...
    retcode = subprocess.call('python tests/test_main.py'.split())
